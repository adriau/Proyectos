...
public class PisoEstandar {
    ...
    public PisoEstandar(char tipo, String codigo, String nombrePropietario, String mesRecibo, float cuotaFija, float agua, float calefaccion) {
        this.tipo=tipo;
        this.codigo = codigo;
    ...
    public int tamañoRegistro() {
        int tamaño = ((nombrePropietario.length() + mesRecibo.length() + codigo.length()) * 2 + 12 + 2);
        return tamaño;
    }
